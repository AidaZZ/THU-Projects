...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Listener for next button. Randomly chooses a song
     * @param view
     */
    ...
    /**
     * Gets the list of all available songs from the phone memory
    ...
    /**
     * Randomly chooses song from index 0 to number of available songs
    ...
    private int randomSong() {
        ...
        int index;
        do {
            index = random.nextInt(cursor.getCount()+1);
    ...
    private Song newSong(int index) {
        ...
        @SuppressLint("Range") String artist = cursor.getString(cursor.getColumnIndex(
                MediaStore.Audio.AudioColumns.ARTIST
        ));

        @SuppressLint("Range") String path = cursor.getString(cursor.getColumnIndex(
    ...
    /**
     * Sets the text view, which represent the details of the song
     */
    ...
    /**
     * Sets the time labels, is being called every second while the song is being played
     */
    ...
    /**
     * Receives the message from the song class once the media is ready to play
     */
